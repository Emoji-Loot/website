    ...
    <Layout>
      <div>
        <div className={styles.home__cta}>
          ...
          {/* CTA Description */}
          <p>
            Emoji Loot is randomized adventurer gear generated and stored on chain.
            <br /> Stats, images, and other functionality are intentionally
            omitted for others to interpret. <br /> Feel free to use Emoji Loot in any
            way you want.
          </p>
        </div>
        ...
        <div className={styles.home__feature}>
          ...
          {getRandomThreeBags().map(({ id, attributes }, i) => (
            ...
            <a
              href={`https://opensea.io/assets/matic/0x99926d145d79567d2f07007e2095a3c1570e6d5e/${id}`}
              target="_blank"
