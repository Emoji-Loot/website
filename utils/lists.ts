// Emoji Loot communities
export const communityList: Record<string, string>[] = [
  {
    name: "Emoji Loot Community Discord",
    description: "For all things Emoji Loot and derivatives (note: high traffic)",
    url: "https://discord.gg/NXEntTSHgy",
  },
  {
    name: "Emoji Loot Talk (Forum)",
    description: "A place for structured discussion of all things Emoji Loot, for builders and the community",
    url: "https://loot-talk.com",
  },
];

// Emoji Loot resources
export const resourceList: Record<string, string>[] = [
  {
    name: "Emoji Loot Rarity",
    description: "Emoji Loot attributes and rarities sheet by @AustinGreen",
  ...
  {
    name: "Emoji Loot subgraph",
    description: "Emoji Loot bag, owner, and transfer subgraph by @shahruz",
  ...
  },
  {
    ...
    description: "Emoji Loot bag and item rarity explorer by @scotato",
  ...
  {
    name: "Emoji LootComponents.sol",
    description: "Utility contract to easily interact with Emoji Loot properties",
...
export const guildsList: Record<string, string>[] = [
  ...
  {
    name: "Divine Lodge",
    description: "For owners of Divine Emoji Loot",
    url: "https://tinyurl.com/divinelodge",
  },
  {
    name: "Ancient Adventurers",
    description: "For owners of Ancient Emoji Loot",
...
export const derivativesList: Record<string, string>[] = [
  ...
  {
    name: "Emoji Loot Personalities v0.1",
  ...
  },
  {
    ...
    url: "https://twitter.com/HolyWarEmoji Loots/status/1432984936747716609",
  },
  {
    name: "Abodes",
    description: "Randomized adventurer dwellings",
    url: "https://twitter.com/Emoji LootAbodes/status/1433031932904935439?s=20",
  },
  {
    name: "Emoji Loot Army",
  ...
  {
    name: "Holy War Emoji Loots",
    description: "The Holy War",
    url: "https://twitter.com/HolyWarEmoji Loots/status/1433293231840653312",
  },
  {
    name: "Treasure",
  ...
  {
    name: "Emoji Loot Avatars",
    description: "The Avatars on chain for Emoji Loot community",
    url: "https://twitter.com/lootavatars",
  },
  {
    name: "Encounters",
    description: "Randomly generated encounters for your Characters and Emoji Loot",
  ...
  {
    name: "Maps",
    description: "Journey maps and location names for your Emoji Loot Adventures.",
